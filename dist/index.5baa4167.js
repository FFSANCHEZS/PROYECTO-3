...
(async function() {
    (0, _axiosDefault.default).get("https://api.frankfurter.app/latest?from=USD").then(function(response) {
...
function addData() {
    if (validateForm() == true) {
        let moneda = document.getElementById("inputInicio").value;
        let valor = document.getElementById("inputFinal").value;
        let listPeople1; // se declara variable listPeople 
        if (localStorage.getItem("listPeople") == null) listPeople1 = [];
        else listPeople1 = JSON.parse(localStorage.getItem("listPeople")); // JSON.parse -> transforma mi objeto en cadena de texto para pasarlo a localStorage
        ...
        localStorage.setItem("listPeople", JSON.stringify(listPeople1)); // stringity -> convierte un objeto o valor de JavaScript en una cadena de texto JSON
...
},{"chart.js/auto":"d8NN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
