...
var _axios = require("axios"); // importacion de axios
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _moment = require("moment/moment");
var _momentDefault = parcelHelpers.interopDefault(_moment);
var _metodos = require("./metodos");
var _metodosDefault = parcelHelpers.interopDefault(_metodos);
var _grafico = require("./grafico");
var _graficoDefault = parcelHelpers.interopDefault(_grafico);
...
function cargarDatos(fechaInicio = null, fechaFinal = null) {
    (0, _axiosDefault.default).get("https://mindicador.cl/api/uf").then(function(response) {
        ...
        if (fechaInicio != null && fechaFinal != null) {
            ...
            datos.forEach(function(element, index) {
                if (fechaInicio <= (0, _momentDefault.default)(element.fecha, "YYYY-MM-DD") && fechaFinal >= (0, _momentDefault.default)(element.fecha, "YYYY-MM-DD")) fechaSeleccionada.push(element);
            });
            (0, _metodosDefault.default)(fechaSeleccionada);
            (0, _graficoDefault.default)(fechaSeleccionada);
        } else {
            (0, _metodosDefault.default)(datos);
            (0, _graficoDefault.default)(datos);
        }
...
btnAdd.addEventListener("click", function() {
    if (validateForm() == true) {
        let fechaInicio = (0, _momentDefault.default)(document.getElementById("inputInicio").value, "YYYY-MM-DD");
        let fechaFinal = (0, _momentDefault.default)(document.getElementById("inputFinal").value, "YYYY-MM-DD");
        console.log(fechaInicio);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./metodos":"dCEzi","moment/moment":"jwcsj","./grafico":"7FWNI"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dCEzi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _moment = require("moment/moment");
var _momentDefault = parcelHelpers.interopDefault(_moment);
function showData(datos) {
    ...
    datos.forEach(function(element, index) {
        ...
        html += "<tr>";
        html += "<td>" + (0, _momentDefault.default)(element.fecha, "YYYY-MM-DD").format("YYYY-MM-DD") + "</td>";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","moment/moment":"jwcsj"}],"jwcsj":[function(require,module,exports) {
//! moment.js
//! version : 2.29.4
...
},{}],"7FWNI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function showGrafico(datos) {
    ...
    new (0, _autoDefault.default)(document.getElementById("myChart"), {
        type: "line",
        data: {
            labels: datos.map((row)=>(0, _momentDefault.default)(row.fecha, "YYYY-MM-DD").format("YYYY-MM-DD")),
            datasets: [
                {
                    label: "UF",
...
exports.default = showGrafico;

},{"chart.js/auto":"d8NN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","moment/moment":"jwcsj"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hF8lp","igcvL"], "igcvL", "parcelRequire072e")
