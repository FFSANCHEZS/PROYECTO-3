...
(0, _axiosDefault.default).get("https://mindicador.cl/api/uf").then(function(response) {
    ...
    (0, _metodosDefault.default)(response.data.serie);
}).catch(function(error) {
    console.log(error);
});
console.log("Termino de cargar") // const fechaHoy = document.getElementById('fechaHoy');
 // fechaHoy.append(moment().format("MMM Do YY"));
;

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./metodos":"dCEzi","moment/moment":"jwcsj"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["hF8lp","igcvL"], "igcvL", "parcelRequire072e")
